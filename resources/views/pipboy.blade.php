...
<head>
    ...
    <link rel="stylesheet" href="css/templates/pipboy.css" />
        ...
        <div class="pipfront">
            ...
            <div class="screen-border">
                <div class="screen">
                    ...
                    <div class="scan"></div>
                    <nav>
                        <span class="active stat"></span><span class="inv"></span><span class="data"></span><span
                            class="map"></span><span class="radio"></span>
                        <p>
                            <span class="status"></span><span class="off special"></span>
                        </p>
                    </nav>
                    <div class="vaultboy">
                        <div class="bar1"></div>
                    ...
                    <div class="supplies">
                        <span>Stimpak (0)</span><span>Radaway (0)</span><span>Stix</span>
                    </div>
                    <div class="info-bar">
