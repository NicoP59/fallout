                        ...
                        <div class="female1">
                            ...
                            <div class="radio">
                                ...
                                <input type="radio" name="avatar" id="female1"
                                    value="img/avatar/female/female1.png">
                            </div>
                        </div>
                        <div class="female2">
                            ...
                            <div class="radio">
                                ...
                                <input type="radio" name="avatar" id="female2"
                                    value="img/avatar/female/female2.png">
                            </div>
                        </div>
                        <div class="female3">
                            <img src="img/avatar/female/female3.png" alt="" class="img-avatar">
                            <div class="radio">
                                <label for="avatar">L'infiltrée</label>
                                <input type="radio" name="avatar" id="female3"
                                    value="img/avatar/female/female3.png">
                            </div>
                        </div>
                        <div class="female4">
                            ...
                            <div class="radio">
                                ...
                                <input type="radio" name="avatar" id="female4"
                                    value="img/avatar/female/female4.png">
                            </div>
                        </div>
                        <div class="female5">
                            ...
                            <div class="radio">
                                ...
                                <input type="radio" name="avatar" id="female5"
                                    value="img/avatar/female/female5.png">
                            </div>
                        </div>
                        <div class="female6">
                            ...
                            <div class="radio">
                                ...
                                <input type="radio" name="avatar" id="female6"
                                    value="img/avatar/female/female6.png">
                            </div>
                        </div>
                        <div class="female7">
                            ...
                            <div class="radio">
                                ...
                                <input type="radio" name="avatar" id="female7"
                                    value="img/avatar/female/female7.png">
                            </div>
                        </div>
                </div>
                </article>
