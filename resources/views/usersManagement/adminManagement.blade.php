...
@section('content')
    <main>
        ...
        <body>
            ...
            <h1 class="titre-usermanagement">LES ADMINISTRATEURS VAULT-TEC</h1>
                ...
                <article class="cards">
                    @foreach ($usersConfrerie as $userConfrerie)
                        <section class="div-carte-user">
                            ...
                            <form method="POST" action="/gestion-administrateurs/{{ $userConfrerie->iduser }}"
                                class="change-type">
                                @csrf
                            ...
                            <a class="text-danger" href="/delete-admin/{{ $userConfrerie->iduser }}"
                ...
                <article class="cards">
                    @foreach ($users as $user)
                        <section class="div-carte-user">
                            ...
                            <form method="POST" action="/gestion-administrateurs/{{ $user->iduser }}" class="change-type">
                                @csrf
                                <label for="type"><i class="bi bi-arrow-clockwise"></i> </label>
                                <input type="submit" name="type" id="change-to-admin" class="change"
                                    value="Utilisateur">
